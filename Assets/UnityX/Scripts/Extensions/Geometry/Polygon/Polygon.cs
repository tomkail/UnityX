...
namespace UnityX.Geometry {
	...
	public class Polygon {
		...
		public bool isClockwise => GetIsClockwise();
		...
		public int VertCount => _vertices.Length;
		...
		public bool connected => (!verticesIsEmpty && _vertices[0] == _vertices[_vertices.Length-1]);
